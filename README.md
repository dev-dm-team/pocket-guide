...
| Besoin                | Outil                                         | Rôle                                                                                                                                                                                                                                                         |
| --------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Framework             | **React (Vite)**                              | Structure du projet — Vite choisi comme socle par défaut (build rapide, pas de couche serveur superflue vu que l'app est 100 % côté client). _À confirmer en équipe : voir section [Décisions techniques ouvertes](#-décisions-techniques-encore-ouvertes)._ |
...
Liens vers les espaces de travail : _(à compléter par l'équipe dès leur création)_
